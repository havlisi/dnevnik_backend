...
//		
//		if (parent.isPresent()) {
//			if (!parent.get().getStudent().isEmpty()) {
//				for (StudentEntity student : parent.get().getStudent()) {
//					student.setParent(null);
//					logger.info("Deleting the parent from a student");
...
//			parentRepository.delete(parent.get());      
//			logger.info("Deleting the parent from the database");
//			return new ResponseEntity<>("Parent with username: " + username + " has been successfully deleted.", HttpStatus.OK);
//		} else {
